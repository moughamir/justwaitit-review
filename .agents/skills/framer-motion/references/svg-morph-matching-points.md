...
function MorphingIcon({ isActive }: { isActive: boolean }) {
  ...
  const starPath =
    'M50,5 L61,40 L98,40 L68,62 L79,97 L50,75 L21,97 L32,62 L2,40 L39,40 Z';
...
function MorphingIcon({ isActive }: { isActive: boolean }) {
  ...
  const circlePath =
    'M50,25 L50,25 L75,50 L75,50 L50,75 L50,75 L25,50 L25,50 L50,25 L50,25';
  const starPath =
    'M50,5 L61,40 L98,40 L68,62 L79,97 L50,75 L21,97 L32,62 L2,40 L39,40';
