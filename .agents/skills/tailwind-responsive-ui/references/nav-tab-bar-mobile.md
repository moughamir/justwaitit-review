...
<nav id="mobile-nav" class="fixed inset-0 z-40 hidden bg-white p-6">
...
<div class="flex min-h-screen flex-col md:flex-row">
  ...
  >
    ...
    <nav class="flex flex-col gap-1">
      <a
        href="/home"
        class="flex items-center gap-3 rounded-lg bg-gray-100 px-3 py-2 text-sm font-medium text-gray-900"
      >
        <svg
          class="h-5 w-5"
          fill="none"
  ...
  <nav
    class="fixed inset-x-0 bottom-0 z-50 flex justify-around border-t bg-white pb-[env(safe-area-inset-bottom)] md:hidden"
  >
    <a
      href="/home"
