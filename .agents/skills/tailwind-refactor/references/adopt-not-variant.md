...
<button
  class="cursor-not-allowed opacity-50 enabled:cursor-pointer enabled:opacity-100"
>
  Submit
</button>
```
...
<button
  class="not-disabled:opacity-100 not-disabled:cursor-pointer cursor-not-allowed opacity-50"
>
  Submit
</button>
```
