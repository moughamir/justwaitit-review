...
<form class="flex flex-col gap-4 rounded-lg bg-white p-6 shadow-md">
  <input class="focus:outline-hidden rounded-md border border-gray-300 px-3 py-2 focus:ring-2 focus:ring-blue-500" />
  <input class="focus:outline-hidden rounded-md border border-gray-300 px-3 py-2 focus:ring-2 focus:ring-blue-500" />
...
function Input(props) {
  return (
    <input
      className="focus:outline-hidden rounded-md border border-gray-300 px-3 py-2 focus:ring-2 focus:ring-blue-500"
      {...props}
    />
  );
}
