...
```html
<span class="bg-gradient-to-r from-indigo-500 to-pink-500 decoration-slice">
  Multi-line highlighted text
</span>
<span class="bg-blue-500 decoration-clone px-2"> Cloned box decoration </span>
```

**Correct (what's right):**

```html
<span class="bg-gradient-to-r from-indigo-500 to-pink-500 box-decoration-slice">
  Multi-line highlighted text
</span>
<span class="bg-blue-500 box-decoration-clone px-2">
