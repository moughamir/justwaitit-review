...
- I/O operations (file writes, network calls, database mutations) inherently have side effects — the principle here is about _hidden_ side effects, not avoiding all mutation. A function named `saveUser()` clearly signals side effects.
