# Testimonial Design Principles

Design principles for social proof that persuades without feeling manipulative or templated.
...
## 2. Lead-Gen vs Client Sites: Critical Distinction
...
### Lead-Gen Sites (No Real Customers Yet)
...
- **Anonymised case studies**: Describe a real problem you solved without identifying the client
- **Your own voice**: Founder story, commitment, values
...
- Large, readable text
- Real photo if available, otherwise just the quote
- Don't diminish a great quote with a tiny card
...
- Different length quotes create visual rhythm
- Avoid perfect symmetry

### Integrated Quotes (Pull Quotes)
...
- Only works if logos are recognisable
...
- Never: "A satisfied customer" or "Happy client"
...
**After presenting services:** You've explained what you do, now prove it works.

**Near CTA sections:** Reduce last-minute doubt. "Other people trusted us, you can too."

**Within service descriptions:** Pull quote format. "We offer 24/7 emergency service" -> testimonial about midnight call-out.

**Not necessarily in their own section:** Testimonials can be woven throughout. Context-relevant placement often works better.

---

## 6. Anti-Patterns

- **Carousel that auto-rotates** — Users can't read at their own pace
- **All testimonials saying the same thing** — Curate for variety: speed, quality, price, communication
- **Stock photo headshots** — Destroys all credibility
- **"John D." level anonymity** — Suggests you're hiding something
- **Three identical card-shaped testimonials** — Template-y, no visual hierarchy
- **All 5-star ratings** — Real reviews have variation; 4.7 is more believable than 5.0

---

## 7. When You Don't Have Testimonials

### Don't Fake Them

Fake testimonials are unethical, potentially illegal, easily discovered, and damage trust permanently.

### Use These Instead

- **Credentials and certifications**: Licensed, insured, industry memberships
- **Guarantees**: Money-back, warranty details, "If we're late, the visit is free"
- **Process descriptions**: Show how you work, what customers can expect
- **Link to review platform**: Even empty, shows transparency
- **Anonymised case studies**: "A homeowner in the Newcastle area contacted us with..."
- **Your own voice**: Founder story, why you started, your commitment
