export function StaticTypoLogo({
  className = '',
  theme = 'light',
}: {
  className?: string;
  ...
  return (
    ...
    >
      ...
      {/* N */}
      <path d={paths.N} fill="url(#logoGradientStatic)" />

      {/* A2 */}
      <path d={paths.A2} fill="url(#logoGradientStatic)" />

      {/* Q */}
      <path d={paths.Q} fill="url(#logoGradientStatic)" />

      {/* I */}
      <path d={paths.I} fill="url(#logoGradientStatic)" />

      {/* O - The Moon/Sun */}
      <g transform="matrix(0.35277777,0,0,-0.35277777,-115.89351,118.58788)">
        <path d={paths.O} fill="url(#logoGradientStatic)" />

        {!isDark && (
          <g className="delay-1000 duration-500 animate-in fade-in zoom-in fill-mode-both">
